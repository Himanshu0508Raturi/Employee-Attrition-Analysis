...
This project performs an end-to-end **exploratory data analysis (EDA)** on the **IBM HR Analytics Employee Attrition & Performance dataset** to identify key factors influencing employee turnover and deliver **actionable business insights**.
...
├── IBM HR Employee Attrition Data.ipynb
├── IBM_HR_EDA_Report.html
├── IBM HR Employee Attrition Analysis.pbix
├── IBM HR Employee Attrition Report.pdf
└── README.md
```
...
## 📝 Project Article
Detailed explanation of the project is available here:  
